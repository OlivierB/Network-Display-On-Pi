...
<div class='slide-div'>
		<div class='row-fluid height-half'>
			<div class="span8" >
				...
				<div  id="weekly-bandwidth-chart" ></div>
			</div>
			<div class="span4">
				<span id="weekly-total-bandwidth-text-alert"></span>
				<div class='bandwith-table' id="weekly-total-bandwidth-text" ></div>
			</div>
		</div>
		...
		<div class='row-fluid height-half'>
			<div class="span6" >
				...
				<div  id="weekly-protocol-use-chart" ></div>
			</div>
			<div class="span6" >
				<span id="weekly-subprotocol-ipv4-use-chart-alert"></span>
				<div  id="weekly-subprotocol-ipv4-use-chart" ></div>
			</div>
		</div>		
</div>
