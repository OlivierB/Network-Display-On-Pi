...
<div class='slide-div'>
		<div class='row-fluid'>
			<div class="span8" >
				...
				<div class='height-half' id="daily-bandwidth-chart" ></div>
			</div>
			<div class="span4">
				<span id="daily-total-bandwidth-text-alert"></span>
				<div class='height-half bandwith-table' id="daily-total-bandwidth-text" ></div>
			</div>
		</div>
		...
		<div class='row-fluid'>
			<div class="span6" >
				...
				<div class='height-half' id="daily-protocol-use-chart" ></div>
			</div>
			<div class="span6" >
				<span id="daily-subprotocol-ipv4-use-chart-alert"></span>
				<div class='height-half' id="daily-subprotocol-ipv4-use-chart" ></div>
			</div>
		</div>		
</div>
