...
********************************************************************************
*/
    $params = parse_ini_file("../base.conf.ini");
   ...
   $base_custom_footer = '';
     ...
     *        $foo = 'c:\tmp\'   [WRONG]
     */
    // $DBlib_path = '/home/student/Prog/Network-Display-On-Pi/www/base/adodb5';
    $DBlib_path = dirname(__FILE__).'/../adodb5';
     ...
     */
    $alert_dbname   = $params['name'];
    $alert_host     = $params['address'];
    $alert_port     = $params['port'];
    $alert_user     = $params['login'];
    $alert_password = $params['password'];
    ...
    $priority_colors = array ('red','yellow','orange','gray','white','blue');
    ...
    include("$BASE_path/perso/$BASE_Language.lang.php");
    ?>
