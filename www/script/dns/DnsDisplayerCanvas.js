...
function DnsDisplayerCanvas(id) {
    ...
    var img = new Image();
    img.src = '/modules/dnsBubble/img/redBubble.png';
    this.images[0] = img;

    img = new Image();
    img.src = '/modules/dnsBubble/img/blueBubble.png';
    this.images[1] = img;

    img = new Image();
    img.src = '/modules/dnsBubble/img/greenBubble.png';
    this.images[2] = img;

    img = new Image();
    img.src = '/modules/dnsBubble/img/bubble.png';
    this.images[3] = img;
    img.onload = function() {
        this.busy = false;
    }.bind(this);
