...
# Default-Stop:      0 1 6
# Short-Description: Network-Display-On-Pi
# Description:       Network Sniffer with web display 
...
do_stop()
{
    ...
    start-stop-daemon --stop --quiet --retry=INT/10 --pidfile $PIDFILE --name $NAME
    RETVAL="$?"
    [ "$RETVAL" = 2 ] && return 2
