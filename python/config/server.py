...
# module_list = ["netmod_classip", "netmod_top", "netmod_iplist", "netmod_loccomm"]
module_list = ["netmod_top", "netmod_iplist", "netmod_loccomm", "netmod_protocols", "netmod_bandwidth"]
